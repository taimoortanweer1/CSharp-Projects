...
namespace serversocket
{
    public partial class Form1 : Form
    {
        ...
        */
        ...
        {
            label5.Text =  readHtmlPage("http://www.sms4connect.com/api/sendsms.php/sendsms/url");
        }
        private String readHtmlPage(string url)
        {
            ...
            String strPost = "id=92test13&pass=demo1313&msg=" + message +
                "&to=923455298838" + "&mask=SMS4CONNECT&type=xml&lang=English";
